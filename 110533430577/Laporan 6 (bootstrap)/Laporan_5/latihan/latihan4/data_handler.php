			...
			if($num){?>
				<div class="tabel">
					<div style="padding:5px;">
						<a class="btn btn-info" href="<?php echo $root;?>&amp;act=add">Tambah Data</a>
					</div>
					<table class="table table-bordered" border="1" width="700" cellpadding="4" cellspacing="0">
						<tr>
							<th>#</th>
							<th width="120">NIM</th>
		...
		if ($view){
			...
			<form action="" method="post">
				<table border="0" cellpadding="4" cellspacing="0">
					<tr>
						<td width="100">NIM*</td>
						<td><input type="text" class="form-control" placeholder="Masukkan NIM " name="nim" size="10" value="<?php echo $nim;?>" /> </td>
					</tr>
					<tr>
						<td>Nama</td>
						<td><input type="text" class="form-control" placeholder="Masukkan Nama " name="nama" size="40" value="<?php echo $nama;?>" /> </td>
					</tr>
					<tr>
						<td>Alamat</td>
